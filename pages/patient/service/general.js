...
const GS = () => {
	...
	const [data, setData] = useState({
		...
		email: "",
		message:
			"Your request has been sent. Please be patient as our medical experts assess your request and respond accordingly",
	});
			...
			<div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
				<div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
					<img
						...
						src="https://images.pexels.com/photos/1170979/pexels-photo-1170979.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
					/>
					<img
				...
				<div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
					...
					<div>
						...
						<p className="text-base leading-4 mt-4 text-gray-600">Physicals</p>
						...
						<p className="md:w-96 text-base leading-normal text-gray-600 mt-4">
							Treatment for various conditioins
						</p>
					</div>
					<div>
		...
		<div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
			...
			<div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
				...
				<div>
					...
					<p className="text-base leading-4 mt-4 text-gray-600">Physicals</p>
					<p className="text-base leading-4 mt-4 text-gray-600">Lab testing</p>
					<p className="text-base leading-4 mt-4 text-gray-600">
						Care for general illnesses
					</p>
					<p className="md:w-96 text-base leading-normal text-gray-600 mt-4">
