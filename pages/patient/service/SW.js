		...
		<div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
			<div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
				<img
					...
					src="https://images.pexels.com/photos/7578803/pexels-photo-7578803.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
				/>
				<img
					className="mt-6 w-full"
					alt="img of a girl posing"
					src="https://images.pexels.com/photos/8413162/pexels-photo-8413162.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
				/>
			</div>
